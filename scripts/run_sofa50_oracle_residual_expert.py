...
from mlr.learned_laplacian.oracle_residual_expert import analyze_oracle_residual_expert


ARM_MAP = {"E0": "oracle_expert_e0", "E1": "oracle_expert_e1"}


def main() -> int:
    parser = argparse.ArgumentParser(description="Run the Sofa50 oracle residual expert diagnostic.")
    ...
    if args.analyze:
        analyze_oracle_residual_expert(args.output_root)
        return 0
